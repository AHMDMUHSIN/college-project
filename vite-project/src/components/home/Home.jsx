   ...
   <div>
     <nav>
        ...
        <div className='homeheadmain'>
            <div className='homehead'>We Rank The Best Course On The Web !</div>
  ...
  <div className="gradient-cards">
    ...
    <div className="card1">
      <div className="container-card bg-white-box">
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="1" y="1" width="118" height="118" rx="24" fill="url(#paint0_linear_1366_4565)"  stroke="url(#paint1_radial_1366_4565)" stroke-width="2"></rect>
        ...
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            ...
            <radialGradient id="paint1_radial_1366_4582" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60 60) rotate(96.8574) scale(122.674 149.921)">
              ...
              <stop offset="1" stop-color="#16161D" ></stop>
            </radialGradient>
          </defs>
        </svg>
...
<div className="main-16-footer-for-md">
  <div className="main-16-sub">
    <div className="main-16-sub1">
      <div className="m16sub1h1">Address</div>
      <div><span><i className="fa fa-map-marker" aria-hidden="true"></i>  123 Street, New York, USA</span></div>
